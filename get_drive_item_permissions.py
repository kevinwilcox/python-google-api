...
# This script attempts to give context to responders by retrieving all Drive
#   permissions based on any of the following criteria:
#   o all Team Drives to which someone has access
#   o all Drive items to which someone has access
#
...
try:
  ...
  print("Error: couldn't assign argument values")
  print(repr(e))
